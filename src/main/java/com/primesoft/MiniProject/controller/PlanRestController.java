package com.primesoft.MiniProject.controller;
...
import com.primesoft.MiniProject.constants.AppConstants;
import com.primesoft.MiniProject.entity.Plan;
import com.primesoft.MiniProject.props.AppProperties;
import com.primesoft.MiniProject.service.PlanService;
...
public class PlanRestController {
	...
	public ResponseEntity<Map<Integer,String>> planCategories(){
		...
		return new ResponseEntity<>(categories, HttpStatus.OK);//map and status=200
